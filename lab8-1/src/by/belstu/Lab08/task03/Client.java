...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        udp.sendMessages("UDP message 1", 4321);
        udp.sendMessages("UDP message 2", 4321);
        udp.sendMessages("UDP message 3", 4321);
        udp.sendMessages("UDP message 4", 4321);
        udp.sendMessages("UDP message 5", 4321);
